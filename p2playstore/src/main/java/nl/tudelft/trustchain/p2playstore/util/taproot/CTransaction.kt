package nl.tudelft.trustchain.p2playstore.util.taproot

import nl.tudelft.ipv8.util.hexToBytes
import nl.tudelft.ipv8.util.sha256
import nl.tudelft.ipv8.util.toHex
import nl.tudelft.trustchain.p2playstore.util.taproot.Messages.Companion.deserializeString
import nl.tudelft.trustchain.p2playstore.util.taproot.Messages.Companion.deserializeStringVector
import nl.tudelft.trustchain.p2playstore.util.taproot.Messages.Companion.deserializeVectorCTxIn
import nl.tudelft.trustchain.p2playstore.util.taproot.Messages.Companion.deserializeVectorCTxOut
import nl.tudelft.trustchain.p2playstore.util.taproot.Messages.Companion.read
import nl.tudelft.trustchain.p2playstore.util.taproot.Messages.Companion.serCompactSize
