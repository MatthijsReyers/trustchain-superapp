...
- **List of DAO's** <br /> <img src="docs/1-alldaos" width="200px"> <br />On the main screen of the system the user finds a list of current DAO's. They can create a new DAO or select one of the existing ones to find more info.
